            ...
            <div className={`container flex-center h-100 ${dark && 'text-light'}`}>
                <div className="row row-cols-1 row-cols-md-2 w-100">
                    <div className="col">
                        ...
                        <a href="https://www.linkedin.com/in/gonzalomorales-web" className="d-block button w-100 mt-2"><i class="fa fa-linkedin-square me-3" aria-hidden="true"></i>LinkedIn</a>
                        <a href="https://github.com/Gonzalomorales1001" className="d-block button w-100 mt-2"><i class="fa fa-github me-3" aria-hidden="true"></i>GitHub</a>
                    </div>
                    <div className="col">
